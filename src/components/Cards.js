        ...
        <>
            ...
            >
                <div className="product-card text-left">
                    ...
                    navigate(`dog/${name}`);
                }} src= { reference_image_id !==undefined ? `https://cdn2.thedogapi.com/images/${reference_image_id}.jpg`:"images/noImage.jpg"} alt={name} loading="lazy" />
                    <div className="product-image-caption">
                        <div className="product-image-txt">
                            <h3>{name}</h3>
                            <NavLink  to={`dog/${name}`}className="btn btn-primary">Read More</NavLink>
                        </div>
                    </div>
                </div>
            </div>
